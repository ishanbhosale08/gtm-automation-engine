# CLAUDE.md - GTM Automation Engine

## Project Overview

**GTM Automation Engine** is an AI-powered automation platform for Go-To-Market teams. It provides 67 specialized plugins with 203 AI agents, 243 business skills, and 20+ workflow orchestrators designed for sales, marketing, growth, customer success, and revenue operations teams.

**Purpose:** Automate repetitive GTM work across prospecting, content creation, analytics, and campaign orchestration.

**Value Proposition:** Automates repetitive GTM work so teams focus on strategy, relationships, and revenue.
...
### Token Optimization
- Average 3.2 components per plugin (follows the recommended 2-8 pattern)
...
Apache License 2.0 - Copyright 2026 ishan bhosale
...
- **Buy Me a Coffee**: [Support Development](https://buymeacoffee.com/tejaskembalkar-ship-it)
