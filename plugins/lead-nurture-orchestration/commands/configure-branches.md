...
> Lifted from GTM Automation Engine orchestrator practices plugins/orchestrator/README.md#112-325.
...
- **Review**: Run `docs/usage-guide.md#orchestration-best-practices` before publishing to ensure agents, dependencies, and deliverables are confirmed.
...
- **Plan maintenance**: each branching change requires updating plan JSON + change log; reference in status packets to keep audit trail aligned with GTM Automation Engine standards.
