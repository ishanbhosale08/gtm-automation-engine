...
- **Review**: Run `docs/usage-guide.md#orchestration-best-practices` before sharing to ensure agent coverage + deliverables are complete.
...
- **Plan maintenance**: every optimization cycle must append results + changes to the plan JSON and status packets, matching GTM Automation Engine audit expectations.
