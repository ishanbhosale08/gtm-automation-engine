...
- **GTM Automation Engine Campaign Planning Checklist** – captures marketing director playbook README.md#183-212.
- **KPI Guardrails Sheet** – track reach, engagement, SQL impact, CAC payback with min/max thresholds.
- **Status Packet Template** – weekly single-slide update mirroring GTM Automation Engine project-manager format TEAM-STRUCTURE.md#193-204.
...
- Borrow GTM Automation Engine's cadence: **Plan → Build → QA → Launch → Inspect** so reporting lines know when to approve or intervene.
...
## GTM Automation Engine Campaign Blueprint (Adopted)
...
5. Risks & Decisions Needed (include GTM Automation Engine-style RAG)
```
