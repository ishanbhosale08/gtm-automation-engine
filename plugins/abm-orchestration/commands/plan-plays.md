...
> Derived from GTM Automation Engine orchestrator model plugins/orchestrator/README.md#112-325.
...
- **Review**: Before execution, run the checklist in `docs/usage-guide.md#orchestration-best-practices` to confirm agents, dependencies, and deliverables.
