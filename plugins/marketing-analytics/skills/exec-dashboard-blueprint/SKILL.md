...
- **GTM Automation Engine KPI Guardrail Sheet** – baseline vs target vs alert ranges for reach, pipeline, win rate, CAC payback README.md#214-241.
- **Measurement Spec** – metric definitions, filters, refresh cadence, owner column.
- **Weekly Exec Packet** – combines dashboard screenshots, narrative summary, decision log (mirrors GTM Automation Engine Data Analyst deliverable).
...
- Adopt GTM Automation Engine cadence: Monday data QA, Tuesday ELT preview, Thursday exec meeting, Friday retro + action register updates.
...
## GTM Automation Engine Dashboard Governance Overlay
...
4. **Escalation** – if guardrail breach persists >2 weeks, escalate to Chief Product Officer / Sales Director per GTM Automation Engine governance.

## KPI Guardrails (GTM Automation Engine Reference)
