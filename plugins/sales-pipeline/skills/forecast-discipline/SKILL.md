...
- **GTM Automation Engine Inspection Worksheet** – standardized questions (deal health, decision process, paper process, risk plan) README.md#244-271.
...
- Mirror GTM Automation Engine cadence: Monday management prep, Tuesday deal desk sync, Thursday exec forecast call.
...
## GTM Automation Engine Forecast Governance Overlay
1. **Call Structure**
   - Start with KPI guardrail review (coverage, wins, slip rate) vs GTM Automation Engine thresholds.
...
Use these prompts in every inspection to match GTM Automation Engine Sales Director rigor.
