...
- **GTM Automation Engine Growth Backlog Board** – capture idea → sizing → prioritization scoring (ICE/RICE) README.md#183-212.
...
- Apply GTM Automation Engine cadence: Monday backlog groom, Wednesday build review, Friday learnings sync.
- Require KPI guardrails per stage (activation, engagement, monetization) before authorizing build.
- If a test risks Sales velocity, include Sales Director in approval routing per GTM Automation Engine governance.

## GTM Automation Engine Experiment Operating Model
...
Share packet with Growth, Marketing Director, Sales Director, and RevOps to mirror GTM Automation Engine's cross-functional communication rhythm.
