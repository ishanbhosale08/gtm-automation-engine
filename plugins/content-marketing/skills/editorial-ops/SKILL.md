...
## Framework
1. **North Star & Themes** – lock the executive thesis and supporting pillars (see GTM Automation Engine Marketing Director guidance README.md#183-212).
...
- Borrow GTM Automation Engine's status packet format (see lifecycle-mapping skill) for weekly exec updates.
