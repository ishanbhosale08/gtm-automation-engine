...
- **GTM Automation Engine Channel Prompt Library** – CTA + hook examples per LinkedIn, X, TikTok, YouTube Shorts README.md#183-212.
...
- Mirror GTM Automation Engine cadence: Monday plan review, Wednesday creative QA, Friday performance readout.
- Keep an escalation macro ready—if sentiment dips below GTM Automation Engine's acceptable range (RAG red), pause scheduled posts within 15 minutes.

## GTM Automation Engine Social Orchestration Overlay
